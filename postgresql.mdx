---
title: "PostgreSQL"
description: "Read and write data to your PostgreSQL database."
---
...
[PostgreSQL](https://www.postgresql.org/) is an open source object-relational database system. With the **PostgreSQL** integration, you can connect to an existing database and bring the data directly into your Glide app. You can both read and write to your PostgreSQL database.

### [BLANK] PostgreSQL - Callout 2

Just getting started with PostgreSQL? [You can read more about how to get set up here.](https://www.postgresql.org/docs/current/intro-whatis.html)
...
8. Disable **SSL certificate** verification if desired. This is less secure.- There are some PostgreSQL platforms that are compatible with this. Consider [Neon](https://neon.tech/) or [Xata](https://xata.io/) if needed. 
...
![PostgreSQL - Image 1](https://images.ctfassets.net/yreygbm72t08/52e1kS1ETUD3Nv6i3qTSVp/c6efbe7eda46cb6332371442b84b45c9/CleanShot_2023-12-18_at_1_.24.39_2x.png)
...
![PostgreSQL - Image 2](https://images.ctfassets.net/yreygbm72t08/3XCAtErZCqgjS9B1pGdver/d192f8a1e2bf38b80de2474ce74fe0ed/CleanShot_2023-12-18_at_1_.25.17_2x.png)
